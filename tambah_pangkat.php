                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="tambah_pangkat.php" class="dropdown-item active">Tambah Pangkat</a>
                        </div>
                    </div>  
                    <div class="nav-item dropdown">
                    ...
                    <div class="col-12">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="form-floating mb-3">
                                <input name="id_pangkat" type="text" class="form-control" id="id_pangkat"
                                    placeholder="id_pangkat">
                                <label for="nrp">ID Pangkat</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input name="nama_pangkat" type="text" class="form-control" id="nama_pangkat"
