            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="jabatan.php" class="dropdown-item active">Daftar Jabatan</a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a class="btn btn-sm btn-outline-warning m-1" href="edit_jabatan.php?id_jabatan=<?php echo $data['id_jabatan']; ?>"><i class="fa fa-edit me-1"></i></a>
                                            <a class="btn btn-sm btn-primary m-1" href="hapus/hps_jabatan.php?id_jabatan=<?php echo $data['id_jabatan'];?>"><i class="fa fa-trash me-1"></i></a>
