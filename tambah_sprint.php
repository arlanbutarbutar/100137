...
<body>
    <?php
        ...
        if($query->num_rows != 0) {
            echo "<div align='center'>Surat Perintah Sudah Terdaftar!</div>";
        } else {
        if(!$no_sprint || !$nrp ) {
       echo "<div align='center'>Masih ada data yang kosong!";
        } else {
       $data = "INSERT INTO sprint (no_sprint, tgl_sprint, id_operasi, id_tugas, nrp, perihal, ket) VALUES ('$no_sprint', '$tgl_sprint', '$id_operasi', '$id_tugas', '$nrp', '$perihal', '$ket')";
       $simpan = $koneksi->query($data);
       if($simpan) {
         echo "<div align='center'>Surat Perintah Sukses Di Tambahkan!</div>";
       } else {
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-file-alt me-2"></i>Surat Perintah</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="sprint.php" class="dropdown-item">Daftar Surat Perintah</a>
                            <a href="tambah_sprint.php" class="dropdown-item active">Tambah Surat Perintah</a>
                        </div>
                    </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Tambah Surat Perintah</h6>
                            <form method="POST" action="">
                            <div class="form-floating mb-3">
                                <input name="no_sprint" type="text" class="form-control" id="nrp"
                                    placeholder="NRP">
                                <label for="nrp">Nomor Surat</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input name="tgl_sprint" type="date" class="form-control" id="nama"
                            ...
                            <div class="form-floating mb-3">
                                <select name="id_operasi" class="form-select" id="floatingSelect"
                                ...
                                <label for="floatingSelect">Operasi</label>
                            </div>
                            <div class="form-floating mb-3">
                                <select name="id_tugas" class="form-select" id="floatingSelect"
                                    aria-label="Floating label select example">
                                    ...
                                    <?php
                                        ...
                                        $no++;
                                        ?>
                                        <option value="<?php echo $data['id_tugas'];?>"><?php echo $data['id_tugas'];?></option>
                                        <?php 
                                        }
                                            ?>
                                </select>
                                <label for="floatingSelect">Tugas</label>
                            </div>
                            <div class="form-floating mb-3">
                                <select name="nrp" class="form-select" id="floatingSelect"
                                    aria-label="Floating label select example">
                                ...
                                <label for="floatingSelect">Personil</label>
                            </div>
                            <div class="form-floating mb-3">
                                <textarea name="perihal" class="form-control" placeholder="Leave a comment here"
                                    id="floatingTextarea" style="height: 150px;"></textarea>
                                <label for="floatingTextarea">Perihal</label>
                            </div>

                            <div class="form-floating mb-3">
                                <textarea name="ket" class="form-control" placeholder="Leave a comment here"
                                    id="floatingTextarea" style="height: 150px;"></textarea>
