                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="tambah_satker.php" class="dropdown-item active">Tambah Satuan Kerja</a>
                        </div>
                    </div> 
                    <div class="nav-item dropdown">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Tambah Satuan Kerja</h6>
                            <form method="POST" action="">
                            <div class="form-floating mb-3">
                                <input name="id_satker" type="text" class="form-control" id="id_satker"
                                    placeholder="id_satker">
                                <label for="nrp">ID Satuan Kerja</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input name="nama_satker" type="text" class="form-control" id="nama_satker"
