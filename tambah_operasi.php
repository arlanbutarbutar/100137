...
?>
   ...
   $status = $_POST['status'];
   $sql = "SELECT * FROM operasi WHERE id_operasi = '$id_operasi'";
   $query = $koneksi->query($sql);
   if($query->num_rows != 0) {
     echo "<div align='center'>Operasi Sudah Ada! <a href='operasi.php'>Back</a></div>";
   } else {
     if(!$id_operasi || !$nama_operasi ) {
       echo "<div align='center'>Masih ada data yang kosong! <a href='tambah_operasi.php'>Back</a>";
     } else {
       $data = "INSERT INTO operasi (id_operasi, nama_operasi, status) VALUES ('$id_operasi', '$nama_operasi', '$status')";
       $simpan = $koneksi->query($data);
       if($simpan) {
         header('location:operasi.php?pesan=operasi-berhasil-tersimpan');
       } else {
         echo "<div align='center'>Proses Gagal!</div>";
       }
     }
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-envelope me-2"></i>Operasi</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="operasi.PHP" class="dropdown-item">Daftar Operasi</a>
                            <a href="tambah_operasi.php" class="dropdown-item active">Tambah Operasi</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
        ...
        <?php if ($_SESSION['level'] == 'anggota') { ?>
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-chart-line me-2"></i>Jabatan</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="jabatan.php" class="dropdown-item">Daftar Jabatan</a>
                        </div>
                    </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Tambah Operasi</h6>
                            <form method="POST" action="">
                            <div class="form-floating mb-3">
                                <input name="id_operasi" type="text" class="form-control" id="id_jabatan"
                                    placeholder="id_jabatan">
                                <label for="nrp">ID Operasi</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input name="nama_operasi" type="text" class="form-control" id="nama_jabatan"
