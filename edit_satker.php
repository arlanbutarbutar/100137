        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="#" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Satuan Kerja</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Edit Satker</h6>
                            <form method="post" action="act_Esatker.php">
                                <?php
                                    
                                    $id_satker = $_GET['id_satker'];
                                    $qry = mysqli_query($koneksi,"select * from satker where id_satker='$id_satker'");
                                    while($data = mysqli_fetch_array($qry)){
                                        ?>
                                <div class="mb-3">
                                   
                                    <input name="id_satkerlama" type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data['id_satker']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">ID Satker</label>
                                    <input name="id_satker" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data['id_satker']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Nama Satker</label>
                                    <input name="nama_satker" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data['nama_satker']; ?>">
                                </div>
                                <button value="EDIT" type="submit" class="btn btn-primary">UPDATE</button>
                                <?php 
                                }
                                ?>
                            </form>
