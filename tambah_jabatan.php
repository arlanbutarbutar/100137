                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="tambah_jabatan.php" class="dropdown-item active">Tambah Jabatan</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                    ...
                    <div class="col-12">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="form-floating mb-3">
                                <input name="id_jabatan" type="text" class="form-control" id="id_jabatan"
                                    placeholder="id_jabatan">
                                <label for="nrp">ID Jabatan</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input name="nama_jabatan" type="text" class="form-control" id="nama_jabatan"
