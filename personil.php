...
<body>
  ...
  <div class="container-fluid position-relative d-flex p-0">
    ...
    <div class="content">
      ...
      <!-- Personil Admin Start -->
      <?php if ($_SESSION['level'] == 'admin') { ?>
        <div class="container-fluid pt-4 px-4">
          <div class="row g-4">
            <div class="col-12">
              <div class="bg-secondary rounded h-100 p-4">
                <h6 class="mb-4">Personil</h6>
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      $qre = mysqli_query($koneksi, "SELECT * FROM tampilpers");
                      $total = mysqli_num_rows($qre);
                      $pages = ceil($total / $halaman);
                      $query = mysqli_query($koneksi, "SELECT * FROM tampilpers LIMIT $mulai, $halaman");
                      $no = $mulai + 1;
                      ...
                      ?>
                        <tr>
                          ...
                          <td scope="row"><?php echo $data['nrp']; ?></td>
                          ...
                          <td>
                            ...
                            <a class="btn btn-sm btn-outline-warning m-1" href="edit_pers.php?nrp=<?php echo $data['nrp']; ?>"><i class="fa fa-edit me-1"></i></a>
                            <a class="btn btn-sm btn-primary m-1" href="hapus/hps_pers.php?nrp=<?php echo $data['nrp']; ?>"><i class="fa fa-trash me-1"></i></a>
                        </tr>
                      <?php
                      }
                      ?>
                  ...
                  <div class="btn-group me-2 active" role="group" aria-label="First group">
                    <?php for ($i = 1; $i <= $pages; $i++) { ?>
                      <a href="?halaman=<?php echo $i; ?>" type="button" class="btn btn-primary"><?php echo $i; ?></a>
                    <?php
                    } ?>
                  </div>
                </div>
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      $query = mysqli_query($koneksi, "SELECT * FROM tampilpers WHERE nrp = '$nrp'");
      ...
      <?php } ?>
      <!-- Personil Anggota End -->

      <!-- Personil kasat Start -->
      <?php if ($_SESSION['level'] == 'kasat') { ?>
        <div class="container-fluid pt-4 px-4">
          <div class="row g-4">
            <div class="col-12">
