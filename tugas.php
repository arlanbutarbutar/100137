        ...
        <?php if ($_SESSION['level'] == 'admin') { ?>
          <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu bg-transparent border-0">
                <a href="tugas.php" class="dropdown-item active">Daftar Penugasan</a>
          ...
          <?php if ($_SESSION['level'] == 'anggota') { ?>
            <div class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                ...
                <span class="d-none d-lg-inline-flex">Surat Perintah</span>
              </a>
              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tbody>
                    <?php
                    $urutan = 0;
                    $query = mysqli_query($koneksi, "SELECT * FROM tampiltugas");
                    while ($data = mysqli_fetch_array($query)) {
                      $urutan++;
                    ?>
                      <tr>
                        <th scope="row"><?php echo $urutan; ?></th>
                        <td scope="row"><?php echo $data['id_tugas']; ?></td>
                        <td scope="row"><?php echo $data['nrp']; ?></td>
                        <td scope="row"><?php echo $data['nama']; ?></td>
                        <td scope="row"><?php echo $data['id_operasi']; ?></td>
                        <td scope="row"><?php echo $data['tempat']; ?></td>
                        <td><?php echo $data['tanggal']; ?></td>
                        <td><?php echo $data['lama_tugas']; ?></td>
                        <td><?php echo $data['status']; ?></td>
                        <td>
                          <a class="btn btn-sm btn-outline-info m-1"><i class="fa fa-search me-1"></i></a>
                          <a class="btn btn-sm btn-outline-warning m-1" href="edit_tugas.php?id_tugas=<?php echo $data['id_tugas']; ?>"><i class="fa fa-edit me-1"></i></a>
                          <a class="btn btn-sm btn-primary m-1" href="hapus/hps_tugas.php?id_tugas=<?php echo $data['id_tugas']; ?>"><i class="fa fa-trash me-1"></i></a>
                      </tr>
                    <?php
                    }
                    ?>
