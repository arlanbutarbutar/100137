        ...
        <?php if ($_SESSION['level'] == 'admin') { ?>
          <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu bg-transparent border-0">
                <a href="operasi.php" class="dropdown-item active">Daftar Operasi</a>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td scope="row"><?php echo $data['nama_operasi']; ?></td>
                        <td scope="row"><?php echo $data['status']; ?></td>
                        <td>
                          <a class="btn btn-sm btn-outline-info m-1"><i class="fa fa-search me-1"></i></a>
                          <a class="btn btn-sm btn-outline-warning m-1" href="edit_operasi.php?id_operasi=<?php echo $data['id_operasi']; ?>"><i class="fa fa-edit me-1"></i></a>
                          <a class="btn btn-sm btn-primary m-1" href="hapus/hps_operasi.php?id_operasi=<?php echo $data['id_operasi']; ?>"><i class="fa fa-trash me-1"></i></a>
                      </tr>
                    <?php
                    }
                    ?>
