            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="tambah_pangkat.php" type="button" class="btn btn-primary ms-2">Tambah Pangkat</a>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a class="btn btn-sm btn-primary" href="edit_pangkat.php?id_pangkat=<?php echo $data['id_pangkat']; ?>">Edit</a><br>
                                    <a class="btn btn-sm btn-primary" href="hps_pangkat.php?id_pangkat=<?php echo $data['id_pangkat'];?>">Hapus</a></td>
                                </tr>
                                <?php
                                }
                                ?>
