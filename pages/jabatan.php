    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                <a href="Beranda.php" class="navbar-brand d-flex d-lg-none me-4">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="tambah_jabatan.php" type="button" class="btn btn-primary ms-2">Tambah Jabatan</a>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a class="btn btn-sm btn-primary" href="edit_jabatan.php?id_jabatan=<?php echo $data['id_jabatan']; ?>">Edit</a><br>
                                    <a class="btn btn-sm btn-primary" href="hps_jabatan.php?id_jabatan=<?php echo $data['id_jabatan'];?>">Hapus</a></td>
                                </tr>
                                <?php
                                }
                                ?>
