        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="#" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Jabatan</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Edit Jabatan</h6>
                            <form method="post" action="act_Ejabatan.php">
                                <?php
                                    
                                    $id_jabatan = $_GET['id_jabatan'];
                                    $qry = mysqli_query($koneksi,"select * from jabatan where id_jabatan='$id_jabatan'");
                                    while($data = mysqli_fetch_array($qry)){
                                        ?>
                                <div class="mb-3">
                                   
                                    <input name="id_jabatanlama" type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data['id_jabatan']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">ID Jabatan</label>
                                    <input name="id_jabatan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data['id_jabatan']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Nama jabatan</label>
                                    <input name="nama_jabatan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data['nama_jabatan']; ?>">
                                </div>
