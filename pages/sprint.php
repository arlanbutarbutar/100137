            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="tambah_sprint.php" type="button" class="btn btn-primary ms-2">Tambah Surat</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                    $urutan = 0; 
                                    $query = mysqli_query($koneksi,"SELECT sprint.no_sprint, sprint.tgl_sprint, sprint.uud, sprint.perihal, personil.nama AS personil_1, sprint.keterangan FROM sprint INNER JOIN personil ON sprint.personil_1 = personil.nrp");
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['tgl_sprint'];?></td>
                                    <td><?php echo $data['uud'];?></td>
                                    <td><?php echo $data['perihal'];?></td>
                                    <td><?php echo $data['personil_1'];?></td>
                                    <td><?php echo $data['keterangan'];?></td>
                                    <td><a class="btn btn-sm btn-primary" href="">Detail</a><br>
                                    <a class="btn btn-sm btn-primary" href="edit_sprint.php?no_sprint=<?php echo $data['no_sprint']; ?>">Edit</a><br>
                                    <a class="btn btn-sm btn-primary" href="hps_sprint.php?no_sprint=<?php echo $data['no_sprint'];?>">Hapus</a></td>
                                </tr>
                                <?php
                                }
                                ?>
