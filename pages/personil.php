            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a class="btn btn-sm btn-primary" href="tambah_personil.php">Tambah Personil</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-4">
                            ...
                            <tbody>
                                <?php
                                    $urutan = 0; 
                                    $query = mysqli_query($koneksi,"SELECT * FROM personil");
                                ...
                                <tr>
                                    ...
                                    <a class="btn btn-sm btn-primary" href="edit_pers.php?nrp=<?php echo $data['nrp']; ?>">Edit</a><br>
                                    <a class="btn btn-sm btn-primary" href="hps_pers.php?nrp=<?php echo $data['nrp'];?>">Hapus</a></td>
                                </tr>
                                <?php
                                }
                                ?>
