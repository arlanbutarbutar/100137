            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Satuan Kerja</h6>
                        <a href="tambah_satker.php" type="button" class="btn btn-primary ms-2">Tambah SATKER</a>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a class="btn btn-sm btn-primary" href="edit_satker.php?id_satker=<?php echo $data['id_satker']; ?>">Edit</a><br>
                                    <a class="btn btn-sm btn-primary" href="hps_satker.php?id_satker=<?php echo $data['id_satker'];?>">Hapus</a></td>
                                </tr>
                                <?php
                                }
                                ?>
