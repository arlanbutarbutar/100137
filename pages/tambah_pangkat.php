            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="post" action="act_Tpangkat.php">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">ID Pangkat</label>
                                    <input name="id_pangkat" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Nama Pangkat</label>
                                    <input name="nama_pangkat" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
