        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="#" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Pangkat</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="post" action="act_Epangkat.php">
                                <?php
                                    
                                    $id_pangkat = $_GET['id_pangkat'];
                                    $qry = mysqli_query($koneksi,"select * from pangkat where id_pangkat='$id_pangkat'");
                                    while($data = mysqli_fetch_array($qry)){
                                        ?>
                                <div class="mb-3">
                                   
                                    <input name="id_pangkatlama" type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data['id_pangkat']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">ID Pangkat</label>
                                    <input name="id_pangkat" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data['id_pangkat']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Nama Pangkat</label>
                                    <input name="nama_pangkat" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data['nama_pangkat']; ?>">
                                </div>
