            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="post" action="act_Tpers.php">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">NRP</label>
                                    <input name="nrp" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="penugasan" class="form-select form-select-sm mb-3" aria-label=".form-select-sm example">
                                        <option selected>Penugasan</option>
                                        <?php
                                                    $kon = mysqli_connect("localhost",'root',"","mintu_reskrim");
                                                    if (!$kon){
                                                        die("Koneksi database gagal:".mysqli_connect_error());
