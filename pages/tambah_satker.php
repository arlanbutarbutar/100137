            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Tambah Satker</h6>
                            <form method="post" action="act_Tsatker.php">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">ID Satker</label>
                                    <input name="id_satker" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Nama Satker</label>
                                    <input name="nama_satker" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
