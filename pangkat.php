        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-bars me-2"></i>Pangkat</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="pangkat.php" class="dropdown-item active">Daftar Pangkat</a>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Pangkat</h6>
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">No</th>
                                            <th scope="col">ID Pangkat</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a class="btn btn-sm btn-outline-warning m-1" href="edit_pangkat.php?id_pangkat=<?php echo $data['id_pangkat']; ?>"><i class="fa fa-edit me-1"></i></a>
                                            <a class="btn btn-sm btn-primary m-1" href="hapus/hps_pangkat.php?id_pangkat=<?php echo $data['id_pangkat'];?>"><i class="fa fa-trash me-1"></i></a>
