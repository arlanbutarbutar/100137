      ...
      <nav class="navbar bg-secondary navbar-dark">
        ...
        <?php if ($_SESSION['level'] == 'admin') { ?>
          <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu bg-transparent border-0">
                <a href="sprint.php" class="dropdown-item active">Daftar Surat Perintah</a>
        ...
        <?php if ($_SESSION['level'] == 'anggota') { ?>
          <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-file-alt me-2"></i>Surat Tugas</a>
              <div class="dropdown-menu bg-transparent border-0">
                <a href="sprint.php" class="dropdown-item active">Daftar Surat Perintah</a>
              </div>
            </div>
          ...
          <div class="row g-4">
            <div class="col-12">
              <div class="bg-secondary rounded h-100 p-4">
                <h6 class="mb-4">Surat Perintah</h6>
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <?php
                      $urutan = 0;
                      $query = mysqli_query($koneksi, "SELECT * FROM personilsprint");
                      while ($data = mysqli_fetch_array($query)) {
                        $urutan++;
                      ?>
                        <tr>
                          <th scope="row"><?php echo $urutan; ?></th>
                          <td scope="row"><?php echo $data['no_sprint']; ?></td>
                          <td scope="row"><?php echo $data['tgl_sprint']; ?></td>
                          <td><?php echo $data['nama']; ?></td>
                          <td><?php echo $data['nama_pangkat']; ?></td>
                          <td><?php echo $data['nama_jabatan']; ?></td>
                          <td><?php echo substr($data['perihal'], 0, 10); ?>...<a href="">(read more)</a></td>
                          <td><?php echo substr($data['ket'], 0, 10); ?>...<a href="">(read more)</a></td>
                          <td><?php echo $data['status_tugas']; ?></td>
                          <td>
                            <a class="btn btn-sm btn-outline-info m-1"><i class="fa fa-search me-1"></i></a>
                            <a class="btn btn-sm btn-outline-warning m-1" href="edit_sprint.php?no_sprint=<?php echo $data['no_sprint']; ?>"><i class="fa fa-edit me-1"></i></a>
                            <a class="btn btn-sm btn-primary m-1" href="hapus/hps_pers.php?no_sprint=<?php echo $data['no_sprint']; ?>"><i class="fa fa-trash me-1"></i></a>
                        </tr>
                      <?php
                      }
                      ?>
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      $nrp = $_SESSION['nrp'];
                      $urutan = 0;
                      $query = mysqli_query($koneksi, "SELECT * FROM personilsprint WHERE nrp = '$nrp' ");
                      while ($data = mysqli_fetch_array($query)) {
                        $urutan++;
                      ?>
                        <tr>
